...
const departments_list_data: DepartmentInformation[] = [
  {
    ...
    information:
      "For HackUPC, the design is really important because it is the way we have to communicate our work. It makes it possible to connect our events with our hackers, sponsors, and partners. Our job is to design everything related to the events of the association, including the most important one, HackUPC. Websites, our social media image, stickers, t-shirts, event decoration, and much more is what we do at our team!",
  },
  {
    name: "Sponsorship",
    question:
  ...
  },
  {
    ...
    information:
      "During HackUPC, we need extra hands to set up the venue and leave everything ready for the hackers, so our team's task is to recruit am amazing team of volunteers who come and help us do so. We coordinate and organize the volunteers to work efficiently, so if you are an organized person who can truly be a leader, this is the place for you!",
  },
];
